...
export const UrgentAlertBanner: React.FC<UrgentAlertBannerProps> = ({ customMessage }) => {
  return (
    <div className="urgent-banner" role="alert">
      <AlertOctagon className="urgent-banner-icon" />
      <div className="urgent-banner-content">
        <h4>High Urgency or Immediate Risk Detected</h4>
        <p>
          {customMessage || 
        ...
        <div className="helpline-badges">
          ...
          <span className="helpline-badge">
            <PhoneCall size={14} /> NALSA Free Legal Aid: 15100
          </span>
          <span className="helpline-badge">
            <PhoneCall size={14} /> Women Helpline: 1091
          </span>
          <span className="helpline-badge">
            <PhoneCall size={14} /> Childline: 1098
          </span>
        </div>
